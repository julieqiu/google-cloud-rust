...
// Package api converts specifications into the `genclient.API` model.
package api
...
func FromOpenAPI(source, serviceConfigFile string, options map[string]string) (*API, error) {
...
func makeResponseMessage(api *API, operation *v3.Operation, packageName string) (*Message, error) {
