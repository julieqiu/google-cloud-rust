...
func newRustService(s *api.Service, c *RustCodec, state *api.APIState) *Service {
	return &Service{
...
func newRustMessage(m *api.Message, c *RustCodec, state *api.APIState) *Message {
	return &Message{
...
func newRustMethod(m *api.Method, c *RustCodec, state *api.APIState) *Method {
	return &Method{
...
func newRustOneOf(oneOf *api.OneOf, c *RustCodec, state *api.APIState) *OneOf {
	return &OneOf{
...
func newRustField(field *api.Field, c *RustCodec, state *api.APIState) *Field {
	return &Field{
...
func newRustEnum(e *api.Enum, c *RustCodec, state *api.APIState) *Enum {
	return &Enum{
...
func newRustEnumValue(ev *api.EnumValue, e *api.Enum, c *RustCodec, state *api.APIState) *EnumValue {
	return &EnumValue{
