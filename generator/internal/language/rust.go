...
// rustMessageScopeName(o.Parent, "", modulePath, sourceSpecificationPackageName, packageMapping)
func rustOneOfType(o *api.OneOf, name string) string {
	return name + "::" + rustToPascal(o.Name)
}
